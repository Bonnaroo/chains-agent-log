...
- Live App A is now internally labeled `v454`, commit `fcb86480fa3ec1770277b759ccdcc9ad1a9283be` (2026-08-05 02:13 UTC). [GPT] opened the cache-busted production URL at a 390×844 viewport at 02:35 UTC and observed `Fantasy DGPT v454`, current league data, T15 `Picks open`, and no initialization hang. The promoted artifact regressed the displayed version from the prior v455 while retaining a fire-and-forget active-round discard call; exact evidence is under T-C04.
