...
2026-08-08 (Engineer, autonomous deploy loop): DEPLOY v474 -> commit 6b4945ca97b3223b0b8ecabfd5e41706c87e261c (rollback point 6385e172208539ceca3278ee6a5c4e239bb7d415). Design could not produce the compiled export (pages are static snapshots; newest was v469), so the bundle was rebuilt from deployed v473: byte-swapped engine.js, identity.js, testdata.js, view_picks.jsx, view_league.jsx, view_admin.jsx with Design's current sources + CHAINS_VERSION bump. Dev-only scripts (view_moneyball/pool-engine/bets/view_bets/view_games) remain excluded, matching the deployed lineage. Staged on test.html (commit 9bedeb27) and 3-level verified there first, then promoted and 3-level verified on index.html: artifact identical via download_url, all five markers present after decompress (FIX 2026-08-07, FIX 2026-08-07 COMMISH, AUTOPICK DISABLED, OWNER OVERRIDE, window.ChainsLive), functional check in live browser (V474 badge, T15 picks stay CLOSED on live evidence, commissioner session recognized, live-synced data). Release record: {"version":"v474","commit":"6b4945ca97b3223b0b8ecabfd5e41706c87e261c","previousCommit":"6385e172208539ceca3278ee6a5c4e239bb7d415","deployedAt":"2026-08-08T09:25:00-04:00","verified":true}. Finding: production never contained a ChainsLive module - only defensive guards in eventStarted(); the real live lock is view_picks' liveStarted /live fetch. Design's "module missing" blocker was a false alarm; Design notified in its chat and acknowledged.
